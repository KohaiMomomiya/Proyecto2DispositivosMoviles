...
public class PreguntasCeguaActivity extends AppCompatActivity {
    ...
    private TextView tvPregunta = (TextView) findViewById(R.id.textPregunta);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPregunta = (TextView) findViewById(R.id.textPregunta);
        tvPregunta.setText(pregunta.getPregunta());

        conjunto = (RadioGroup) findViewById(R.id.conjunto2);
